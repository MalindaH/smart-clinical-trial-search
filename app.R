...
shinyApp(
  ui <- navbarPage("Smart Clinical Trial Search for Small Molecule Drugs",
                  ...
                  tabPanel("Authors",
                       ...
                       p("Developed in ", a("PharmaHacks 2022", href="https://devpost.com/software/smart-clinical-trial-search-for-small-molecule-drugs")), style = "padding: 0 100px 0 100px; text-align: center;"))
                   ),
